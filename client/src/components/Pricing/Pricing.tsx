...
export default function Pricing({ features }: PricingProps) {
  return (
    <div className="mt-20 rounded-md py-24 transition duration-500 ease-in-out sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl bg-gray-50 ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            <h3 className="text-center text-2xl font-bold tracking-tight text-gray-900 md:text-left">
              Beta Access
            </h3>
