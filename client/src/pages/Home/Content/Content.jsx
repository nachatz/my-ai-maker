  ...
  return (
    <div className="mx-auto max-w-2xl lg:text-center mt-10">
      ...
      <div className="flex justify-center mt-8">
        <button className="bg-primary-500 text-white font-semibold py-2 px-5 rounded-md shadow-md hover:bg-indigo-400 focus:outline-none focus:ring-1 focus:ring-indigo-400 focus:ring-offset-1">
