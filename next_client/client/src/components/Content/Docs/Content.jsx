      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img
            ...
            src="https://media.istockphoto.com/id/576604058/photo/3d-printed-hypercube.jpg?b=1&s=612x612&w=0&k=20&c=SKwLdOjT0ZsYx9KK8JkseEsKx1ztXVGAKRq4DRw9hO8="
            alt=""
          />
        </div>
              ...
              <ul className="mt-8 space-y-8 text-gray-600">
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    Create a column explicitly called 'label' and put the truth
                    value for each row. For example, if we are trying to predict
                    if someone likes the color blue, we would put 'yes' or 'no'
                    in the label column for each row.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  3.
